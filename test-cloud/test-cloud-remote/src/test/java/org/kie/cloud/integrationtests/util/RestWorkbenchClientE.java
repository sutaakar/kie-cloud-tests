...
public class RestWorkbenchClientE implements WorkbenchClient {
    ...
    private RestWorkbenchClientE(String appUrl, String userId, String password, boolean async,
    ...
    public static WorkbenchClient createAsyncWorkbenchClient(String appUrl, String userId, String password) {
        return new RestWorkbenchClientE(appUrl, userId, password, true);
    }
    ...
    public static WorkbenchClient createWorkbenchClient(String appUrl, String userId, String password) {
        return new RestWorkbenchClientE(appUrl, userId, password, false);
    }
