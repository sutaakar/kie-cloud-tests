    ...
    public static Collection<Object[]> data() {
        ...
        try {
            KieServerWithDatabaseScenario kieServerMySqlScenario = deploymentScenarioFactory.getKieServerWithMySqlScenarioBuilder()
                .withNexusMavenRepoDeployedInAdvance()
                .withPreDeploymentListener(scenario -> {
                    scenario.getNexusDeployment().ifPresent(nexusDeployment -> {
                        URL snapshotRepoUrl = nexusDeployment.getSnapshotRepoUrl();
                        MavenDeployer.buildAndDeployMavenProjectToRepository(ClassLoader.class.getResource("/kjars-sources/hello-rules-snapshot").getFile(), snapshotRepoUrl);
                    });
                })
